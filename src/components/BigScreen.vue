        ...
        <div class="main">
            <div class="left">
                <div class="cityEvent" v-for="item,key in props.dataInfo" :key="key">
                    ...
                    <h1>
                        ...
                        <span>{{toFixxedInt(item.number)}}（{{item.unit}}）</span>
                    </h1>
            ...
            <div class="right">
                <div class="cityEvent list">
                    ...
                    <ul>
                        <li v-for="item,i in props.eventList" :key="i" :class="{active:currentActive==i}" @click="toggleEvent(i)">
                            <h1>
                                <div>
